...
public class NocneZoo {
    public static void main(String[] args) {
        ...
        zoo.dodajWybieg(new Wybieg_Powietrzny(wielkosc_wybiegu_enum.SREDNI));
        zoo.getListaWybiegow().get(0).dodaj_zwierze(new Zwierze("1",1,1,1,1,1,1,1, rodzaj_srodowiska_enum.POWIETRZNY));
        //
