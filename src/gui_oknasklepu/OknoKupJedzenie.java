...
public class OknoKupJedzenie extends JFrame implements ActionListener {
    ...
    public OknoKupJedzenie (DzienneZoo zoo, Sklep sklepik)
    {
        this.zoo=zoo;
        ...
        JButton kupButton = new JButton("Kup jedzenie " + " | Obecna cena za sztukę to: " + sklepik.getCena_sztuka_jedzenie());
        panel.add(kupButton);
